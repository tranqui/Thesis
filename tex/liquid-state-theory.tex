...
\begin{equation}\label{eq:consistent-osmotic-pressure}
  \begin{split}
    \beta p
    &=
...
Inversion of this relation yields the useful form
...
Alternatively, the virial series can be expressed for the (excess) free energy density using \eqref{eq:free-energy-density} as
...
\begin{tcolorbox}[title=The virial coefficients]
  ...
  In graph theoretic terms, these diagrams would be called \emph{2-vertex connected}.}:
...
We will now review its extensions to inhomogeneous systems in the following sections.
