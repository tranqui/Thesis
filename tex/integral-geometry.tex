...
\item They increase additively, i.e.\ they transform under combination of subsystems via the inclusion/exclusion relation e.g.\ for two objects $K_1$ and $K_2$
  ...
  As corollaries, this property contains the expectation that the size of nothing is zero, e.g.\ $V[\emptyset] = 0$ and the homogeneity property of extensive variables \eqref{eq:extensive-homogeneity}.
