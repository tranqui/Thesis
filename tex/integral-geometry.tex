...
We give some properties of the Euler characteristic below.
...
\hl{Finishing paragraph connecting to next section...}
...
We define the $k$th intrisic volume as the average size of the projections onto $k$-dimensional linear subspaces of $\mathbb{R}^d$, i.e.\ \cite{Santalo}
...
\end{equation}
\todo{Check subscripts of $E$.}
where the integral is taken over all affine transformations of the plane $E_k$ in $\mathbb{R}^d$, and flag coefficient
...
We will see the intrinsic volumes used in the construction of a theory for the hard sphere liquid in section \ref{sec:fmt}.
