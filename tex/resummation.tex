...
In particular, the interaction potential between two compact, convex hard bodies $A,B \in \mathcal{K}^d$ is normally written
...
We perform this resummation explicitly in physical dimensions $d \le 3$ in the next section.
...
Notably, the resummation of the ring integrals would lead to a contribution in $\Delta \Omega$ involving a double volume integral over the solute.
