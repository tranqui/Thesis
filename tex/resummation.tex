...
\section{Notation and intrinsic volumes}
\label{sec:morph-overview}
...
\begin{figure}
  \begin{minipage}{\linewidth}
    \centering
    \includegraphics[width=0.75\linewidth]{resummation-pressure}
  \end{minipage}
  \caption{Equations of state for the single-component hard sphere liquid: Carnahan-Starling (CS), the scaled particle/Percus Yevick (SPT/PY) and the equation obtained from resumming terms in the virial series where there is a commong point of intersection.
...
\begin{figure}
  \begin{minipage}{\linewidth}
    \centering
    \includegraphics[width=0.75\linewidth]{resummation-a2}
  \end{minipage}
  \caption{Comparison of surface tensions for different morphometric theories.
...
%% \begin{figure*}
%%   \includegraphics[width=0.65\linewidth]{minkowski_addition}
