...
%% \begin{figure*}
%%   \includegraphics[width=\linewidth]{structure_populations}
%%   \caption{
%%     (color online)
%%     Static many-body structure in the hard sphere liquid.
%%     Left: populations of small local structures in the hard sphere liquid determined from molecular dynamics simulations of 1372 monodisperse (open circles) and 8\% polydisperse (solid triangles) hard spheres against the theoretical prediction of this work (lines).
...
%%     Right: theoretical free energy distribution for the $n=12$ local library of states at several volume fractions.
