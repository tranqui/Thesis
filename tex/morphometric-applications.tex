...
\todo{Indicate what makes something rigid.}
...
\marginfootnote{We are skipping an important step here, because it requires formalism to be introduced in section \ref{sec:bond-distance}.
  ...
  Evaluating this Gaussian over all of space i.e.\ $y_k \in [-\infty, \infty]$ introduces a small approximation as we have the geometrical lower bound $y_k > -\sigma$.}.
...
\end{SCfigure}
\todo{Make dimensions of n7 figure same as n6 figure.}
