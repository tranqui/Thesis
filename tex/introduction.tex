...
\todo{These are not thermal, so be careful.}
...
In this context, nucleation predictions become remarkably accurate.}[-3cm]
...
\todo{Be careful with Gardner: HS are thermal, so pressure diverges. Jamming is more a granular matter thing.}
