...
\todo{A lot of this is repeated: review after finishing lit review.}
...
\todo{Link in with background section on geometry}
\begin{enumerate}
...
\marginfootnote{We use a different normalisation of the intrinsic volumes in this chapter, so $a_1$ and $a_0$ must be multiplied through by $4\pi$ to recover \eqref{eq:cs-spt-coefficients}.}.
