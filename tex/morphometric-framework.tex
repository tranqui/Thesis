...
\begin{SCfigure}
  \includegraphics[width=\linewidth]{morph-droplet}
  \caption{
...
\begin{SCfigure}
  \begin{minipage}{\linewidth}
    \centering
    \includegraphics[width=0.75\linewidth]{g2-contact}
  \end{minipage}
  \caption{
...
\begin{SCfigure}
  \begin{minipage}{\linewidth}
    \centering
    \includegraphics[width=0.75\linewidth]{g2-phi045}
  \end{minipage}
...
The main equation of state we will impose is the Carnahan-Starling (CS) relation \cite{CarnahanJCP1969}\todo{Move equations of state into the background chapter.}
\begin{equation}\label{eq:cs-pressure}
  \frac{\beta p}{\rho} = \frac{1 + \eta + \eta^2 - \eta^3}{(1-\eta)^3},
\end{equation}
which is known to be accurate across the whole stable liquid regime, and even at the limits of the supercooled liquid accessible to simulations \cite{BerthierPRL2016}.
...
\begin{SCfigure}
  \begin{minipage}{\linewidth}
    \centering
    \includegraphics[width=0.75\linewidth]{g3}
  \end{minipage}
...
\begin{SCfigure}
  \begin{minipage}{\linewidth}
    \centering
    \includegraphics[width=0.75\linewidth]{sp3}
  \end{minipage}
...
\begin{SCfigure}
  \begin{minipage}{\linewidth}
    \centering
    \includegraphics[width=0.75\linewidth]{a2-errors}
  \end{minipage}
