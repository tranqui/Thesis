\section{Insertion cost is not generally analytic in geometric measures}
\label{sec:singularities}

Here we review the arguments made by Reiss and coworkers \cite{ReissJCP1959,ReissJCP1960} that the grand canonical cost of insertion contains singularities.
...
A summary of the first few singularities in three-dimensions is given in Table~\ref{table:singularities}.
...
\begin{table}
  \begin{ruledtabular}
    ...
    \end{tabular}
  \end{ruledtabular}
  \caption{First few singularities in the cost of inserting a sphere of radius $R$ into a one-component hard sphere liquid of diameter $\sigma$ in $d=3$.
