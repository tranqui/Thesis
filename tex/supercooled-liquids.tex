...
In hard spheres, the dominant LFS are found to be icosahedral motifs just as in Frank's original conjecture.
In Fig.\ \ref{fig:icosahedral-domains} we see the growth of large domains of icosahedra in the supercooled liquid, over a range in densities where $\tau_\alpha$ changes by a factor of $\mathcal{O}(10^5)$ (Fig.\ \ref{fig:g2-evolution}) \cite{HallettNC2018}.
