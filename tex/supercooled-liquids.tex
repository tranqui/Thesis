...
\begin{SCfigure}
  ...
  \caption[Structural change in the supercooled liquid (at the pair level)]{
    ...
    Results for $\eta = 0.45$ for a 7-component equimolar mixture with 20\% polydispersity using the DynamO software package \cite{BannermanJCC2011}, whereas the data in metastable regime is from colloidal experiments provided by the authors of Ref.\ \cite{HallettNC2018}.
  }
