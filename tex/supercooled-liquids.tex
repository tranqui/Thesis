...
\marginfootnote{Equivalent to density, with the connection made through the equation of state $p = p(\rho)$.}
...
Notably, the agreement of dynamical facilitation with available data is comparable with the mean-field/RFOT scenario up to the experimental glass transition \cite{ChandlerARPC2010}.
