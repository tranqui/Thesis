...
\subsection{Thermodynamic potentials in functional form}
...
\subsection{Bulk limits of fundamental measure theory}
...
\begin{equation}
  ...
  \partial^n_{\alpha_1, \alpha_2, \cdots, \alpha_n} \beta\Phi^\mathrm{ex} \;
